...
export default function FormProveedor({
  ...
  const onsubmit = async (data) => {
    ...
    if (repetidos) {
      ...
      await axios.post(
        "https://contableserver.azurewebsites.net/postProveedor",
        NuevProveedor
      );
      fechData();
      setEstado(!estado);
          ...
          >
            ...
            <div>
              ...
              {errors.Codigo?.type === "minLength" && (
                <p className="alerta">El minimo de caracteres son 6</p>
              )}
              {errors.Codigo?.type === "maxLength" && (
                <p className="alerta">El limite de carecteres son 6</p>
              )}
            ...
            <div>
              {errors.Rnc?.type === "required" && (
                <p className="alerta">El Campo Rnc es requerido</p>
              )}
              {errors.Rnc?.type === "maxLength" && (
                <p className="alerta">El Rnc debe ser menor 13 Digitos</p>
              )}
              {errors.Rnc?.type === "minLength" && (
                <p className="alerta">El Rnc debe ser mayor 9 digitos</p>
              )}
            ...
            <div>
              {errors.Correo?.type === "required" && (
                <p className="alerta">El Campo Correo es requerido</p>
              )}
              {errors.Correo?.type === "pattern" && (
                <p className="alerta">El Correo no es valido</p>
              )}
              <label>Correo:</label>
              <input
                type="text"
