...
export default function Cliente({RegistradoPor}){
    ...
    const fechData= async ()=>{
        const ClienteData = await axios.get("http://localhost:4000/getcliente")
    ...
    const fechDataTrans = async ()=>{
        const TransData = await axios.get("http://localhost:4000/getTrans")
        ...
        try {
            ...
            if(number.length === 2){
                ...
                if(!hay_negativo && hay_positivo ){
                    ...
                    const respuesta = await axios.post("http://localhost:4000/liquidar",dataLiqui)
                    ...
                    if(respuesta){
                        if(value >= 0){
                         ...
                         const RegistroCorrecto = await axios.post("http://localhost:4000/postTrans",nuevoIngreso)
                         if(RegistroCorrecto){
