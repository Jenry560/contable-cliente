  ...
  return (
    <Router>
      <Routes>
        <Route
          element={
            <ProtectedRoute canActivate={user} redirectPath={"/signs"} />
          }
        >
          <Route path="/" element={<App />}>
            ...
            <Route
              path="cliente"
              element={<Cliente RegistradoPor={user && user.Correo} />}
            />
            <Route
              path="Proveedores"
              element={<Proveedor RegistradoPor={user && user.Correo} />}
            />
            <Route
              path="registro"
              element={<Registro RegistradoPor={user && user.Correo} />}
            />
            <Route
              path="cxc"
              element={
                <Cobrar
                  ...
                  codigo="CXC"
                  RegistradoPor={user && user.Correo}
                  icon={<TbPigMoney className="ite" />}
                />
              }
            />
            <Route
            ...
            <Route
              ...
              element={
                <Modelo
                  ...
                  codigo="7090"
                  RegistradoPor={user && user.Correo}
                  icon={<BsFillHouseAddFill className="ite" />}
                />
              }
            />
            <Route
              ...
              element={
                <Diario
                  RegistradoPor={user && user.Correo}
                  icon={<RiNewspaperLine className="ite" />}
                />
              }
            />
          </Route>
